...
def is_three_fingers_up(landmarks):
    ...
    try:
        ...
        thumb_down = landmarks[4].y > landmarks[13].y
        ...
        return (index_up and middle_up and ring_up and pinky_down and thumb_down and
...
def is_hand_closed(landmarks):
    ...
    try:
        return landmarks[8].y > landmarks[6].y and landmarks[12].y > landmarks[10].y  # Index finger folded
    except:
        return True
